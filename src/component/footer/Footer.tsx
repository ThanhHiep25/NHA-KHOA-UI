        ...
        <footer className="bg-white backdrop-blur-md">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="" className="flex items-center">
                            <Image src="/LOGO/Logo_Horizontal_Light_1-1024x237.png.webp" alt="FlowBite Logo" width={200} height={32} className="h-10 me-3" />
                        </a>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="" className="hover:underline">Camtu Dental™</a>. All Rights Reserved.
                    </span>
